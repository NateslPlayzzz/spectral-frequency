...
# Runs as the Taken player after they have already been teleported to the remnant.
...
title @s subtitle {"text":"someone held onto you","color":"white","italic":true}
...
tellraw @a[tag=sf.case_participant] [{"text":"[","color":"dark_gray"},{"text":"◇","color":"#7A5CFF"},{"text":"] ","color":"dark_gray"},{"selector":"@s","color":"white"},{"text":" has been remembered.","color":"gray"}]