# tool/spiritbox/deceive.mcfunction — coherence-scaled lie (same model as EMF/thermo)
...
execute if score #roll sf.data <= #decep sf.data run function sf:tool/spiritbox/flip