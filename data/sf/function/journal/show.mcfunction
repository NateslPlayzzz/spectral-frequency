...
tellraw @s [{"text":"  STATUS  ","color":"#6A6A78","bold":true},{"text":"ACTIVE","color":"#9BFFB0","bold":true},{"text":"  ·  ","color":"dark_gray"},{"score":{"name":"#evidence_count","objective":"sf.data"},"color":"white","bold":true},{"text":" signs recorded","color":"gray"},{"text":"  ·  ","color":"dark_gray"},{"text":"3 required","color":"#D8C8A0"}]
...
execute if score #evidence_count sf.data matches ..2 run tellraw @s [{"text":"\n  Continue gathering signs before attempting classification.","color":"#8A8A98","italic":true}]

execute if score #evidence_count sf.data matches 3.. if score @s sf.case_id matches 0 run tellraw @s [{"text":"\n  ▶ ","color":"#7A5CFF"},{"text":"CLASSIFY MANIFESTATION","color":"#D8C8A0","bold":true,"underlined":true,"click_event":{"action":"run_command","command":"/trigger sf.journal set 2"},"hover_event":{"action":"show_text","value":{"text":"Open the UMBRA manifestation registry."}}}]

execute if score #evidence_count sf.data matches 3.. if score @s sf.case_id matches 1..12 run tellraw @s [{"text":"\n  ▶ ","color":"#7A5CFF"},{"text":"REVISE CLASSIFICATION","color":"#D8C8A0","underlined":true,"click_event":{"action":"run_command","command":"/trigger sf.journal set 2"},"hover_event":{"action":"show_text","value":{"text":"Choose a different registered fragment."}}}]

# Tutorial and lifetime evidence checks remain active.
