...
execute if entity @s[tag=sf.seen_whisper] run tellraw @s [{"text":"Whisper","color":"white"},{"text":" — Spirit Box, Ghost Writing, Veil Echo","color":"#8A8A98"}]
...
execute if entity @s[tag=sf.seen_phantom] run tellraw @s [{"text":"Phantom","color":"white"},{"text":" — EMF, Ghost Writing, Veil Echo","color":"#8A8A98"}]
execute unless entity @s[tag=sf.seen_phantom] run tellraw @s [{"text":"———","color":"#5A4A4A"},{"text":" — unremembered","color":"#5A4A4A","italic":true}]

execute if entity @s[tag=sf.seen_shade] run tellraw @s [{"text":"Shade","color":"white"},{"text":" — Ghost Writing, UV Traces, Veil Echo","color":"#8A8A98"}]
...
execute if entity @s[tag=sf.seen_dread] run tellraw @s [{"text":"The Dread","color":"white"},{"text":" — EMF, UV Traces, Veil Echo","color":"#8A8A98"}]
