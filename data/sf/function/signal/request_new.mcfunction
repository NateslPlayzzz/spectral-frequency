...
execute unless data storage sf:forgotten {state:"idle"} run return run tellraw @s [{"text":"[","color":"dark_gray"},{"text":"VANCE","color":"#5AC8C8","bold":true},{"text":"] ","color":"dark_gray"},{"text":"Not now. Something else has already found the channel.","color":"#C89BFF","italic":true}]
