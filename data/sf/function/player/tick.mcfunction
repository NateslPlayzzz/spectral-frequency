...
# Current Case Journal routing.
# 1 = open journal
# 2 = open classification dialog
# 11–22 = select registered fragment 1–12
execute if score @s sf.journal matches 1 run function sf:journal/show
execute if score @s sf.journal matches 2 run function sf:journal/identify_menu
execute if score @s sf.journal matches 11..22 run function sf:journal/select
