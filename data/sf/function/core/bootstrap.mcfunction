# core/bootstrap.mcfunction
# First-install only. core/load calls this only while sf:config initialized is absent.
...
# Memory bossbar pool. Online players are reassigned uniquely once per second.
bossbar add sf:mem0 {"text":"MEMORY","color":"#7A5CFF"}
bossbar add sf:mem1 {"text":"MEMORY","color":"#7A5CFF"}
bossbar add sf:mem2 {"text":"MEMORY","color":"#7A5CFF"}
bossbar add sf:mem3 {"text":"MEMORY","color":"#7A5CFF"}
bossbar add sf:mem4 {"text":"MEMORY","color":"#7A5CFF"}
bossbar add sf:mem5 {"text":"MEMORY","color":"#7A5CFF"}
bossbar add sf:mem6 {"text":"MEMORY","color":"#7A5CFF"}
bossbar add sf:mem7 {"text":"MEMORY","color":"#7A5CFF"}
